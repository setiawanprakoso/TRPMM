...
public class drum extends Activity implements SurfaceHolder.Callback, MediaPlayer.OnPreparedListener {
    ...
    private class GetVideo extends AsyncTask<Void, Void, Void> {
        ...
        protected void onPreExecute() {
            ...
            pDialog = new ProgressDialog(drum.this);
        ...
        protected void onPostExecute(Void result) {
            ...
            list = (ListView) findViewById(R.id.listVideodrum);
            String[] title = new String[listVideoMain.size()];
            for (int j = 0; j < listVideoMain.size(); j++) {
                title[j] = listVideoMain.get(j).title;
            }
            ArrayAdapter<String> adapter = new ArrayAdapter<String>(drum.this, android.R.layout.simple_list_item_1, android.R.id.text1, title);
            ...
            list.setOnItemClickListener(new AdapterView.OnItemClickListener() {
                ...
                public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                    ...
                    i = new Intent(drum.this, drum2.class);
                    b = new Bundle();
