...
public class piano extends Activity implements SurfaceHolder.Callback, MediaPlayer.OnPreparedListener {
    private static String url ="https://archive.org/advancedsearch.php?q=mediatype%3A%22movies%22+AND+title%3A%22piano+lesson%22&fl%5B0%5D=date&fl%5B1%5D=description&fl%5B2%5D=downloads&fl%5B3%5D=identifier&fl%5B4%5D=subject&fl%5B5%5D=title&fl%5B6%5D=year&sort%5B0%5D&sort%5B1%5D&sort%5B2%5D&rows=50&page=1&output=jsonl%5B3%5D=identifier&fl%5B4%5D=subject&fl%5B5%5D=title&fl%5B6%5D=year&sort%5B0%5D&sort%5B1%5D&sort%5B2%5D&rows=50&page=1&output=json";
    ListView list;
    String videoURL;
    Intent i;
    Bundle b;
    ...
    private class GetVideo extends AsyncTask<Void, Void, Void> {
        ...
        protected void onPreExecute() {
            ...
            pDialog = new ProgressDialog(piano.this);
        ...
        protected void onPostExecute(Void result) {
            ...
            list = (ListView) findViewById(R.id.listVideopian);
            String[] title = new String[listVideoMain.size()];
            for (int j = 0; j < listVideoMain.size(); j++) {
                title[j] = listVideoMain.get(j).title;
            }
            ArrayAdapter<String> adapter = new ArrayAdapter<String>(piano.this, android.R.layout.simple_list_item_1, android.R.id.text1, title);
            ...
            list.setOnItemClickListener(new AdapterView.OnItemClickListener() {
                ...
                public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                    ...
                    i = new Intent(piano.this, piano2.class);
                    b = new Bundle();
